...
def measure(context_length: int) -> dict[str, object]:
    torch.manual_seed(0)
    ...
    inputs = torch.zeros((1, context_length), dtype=torch.long)
    ...
    return {
        ...
        "run_id": f"cpu-context-{context_length}",
...
def main() -> None:
    ...
    for context_length in args.contexts:
        ...
        print(json.dumps(measure(context_length), sort_keys=True, separators=(",", ":")))
